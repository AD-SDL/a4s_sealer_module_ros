...
def generate_launch_description():
  ...
  pkg_share = FindPackageShare(package='azenta_description').find('azenta_description')
  default_rviz_config_path = os.path.join(pkg_share, 'config/sealer_rviz_config.rviz')
  default_urdf_model_path = os.path.join(pkg_share, 'urdf/sealer_module.xacro') 
  ...
  start_azenta_description_client = Node(
    ...
    executable = 'sealer_description_client',
    name = 'SealerDescriptionNode',
    output = 'screen'
  )
